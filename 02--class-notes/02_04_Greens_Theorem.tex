...
\begin{center}
	\includegraphics[scale = 0.25]{Figures/10_5_Fig2.png}\\
...
\begin{column}{6.0cm}
	...
	\only<1>{\includegraphics[scale = 0.3]{Figures/10_5_Fig3.png}}
	\only<2>{\includegraphics[scale = 0.3]{Figures/10_5_Fig10.png}}
	\only<3->{\includegraphics[scale = 0.3]{Figures/10_5_Fig11.png}}
\end{column}
\begin{column}{4.5cm}
	...
	\only<1-5>{\includegraphics[scale = 0.2]{Figures/10_5_Fig7.png}}
	\only<6>{\includegraphics[scale = 0.2]{Figures/10_5_Fig8.png}}
	\only<7>{\includegraphics[scale = 0.2]{Figures/10_5_Fig9.png}}
	\only<8->{\includegraphics[scale = 0.2]{Figures/10_5_Fig6.png}}
\end{column}
\end{columns}
...
\begin{center}
	\includegraphics[scale = 0.24]{Figures/10_5_Fig2.png}
\end{center}
...
\includegraphics[scale = 0.25]{Figures/10_5_Fig3.png}
\end{column}
\begin{column}{5.4cm}
Normal Form:
...
Compute \quad $\D{\oint \limits_{C} {\bf F} \cdot {\bf T}\, ds \quad \text{and} \quad \oint \limits_{C} {\bf F} \cdot {\bf N}\, ds}$
