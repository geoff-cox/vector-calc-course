...
%\BCOLS
%\BCOL{8.0cm}
%\includegraphics[scale = 0.2]{\PATHTOFIGS/VL_Calc1_Fig1_8.png}
%\includegraphics[scale = 0.2]{\PATHTOFIGS/VL_Calc1_Fig1_9.png}
%\ECOL
%\BCOL{5.9cm}
%
%\ECOL
...
%	\multirow{4}{*}{\includegraphics[scale = 0.7]{\PATHTOFIGS/01_01_Fig_10.jpg}} & \\
%	\\
...
\begin{tabular}{| c | c |}
	...
	\hline
	$s(1)$ & 
	\ON<1>{\B{The position of $\mathcal{O}$ after 1s}}\\
	\hline
	$s(0)$ & 
	\ON<1>{\B{The initial position of $\mathcal{O}$}}\\
	\hline
	\ON<1>{\B{$s(6)$}} & 
	The position of $\mathcal{O}$ after 6s\\
	\hline
	$s(7)-s(4)$ & 
	\ON<1>{\B{$\mathcal{O}$'s change position (distance traveled) between 4s and 7s}}\\
	\hline
	\ON<1>{\B{$s(3)-s(0)$}} & 
...
\begin{tabular}{p{0.25cm}p{13.6cm}}
	...
	\\
	& \ON<1>{\B{$\D{s(1) = -16(1)^2+96(1) = -16+96 = 80 \, ft}$}} \\
	& \\
	(b) & What was average velocity of the rock between 1 s and 3 s? \\
	\\
	& \ON<1>{\B{$\D{\bar{v}_{1 \to 3} = \frac{s(3)-s(1)}{3-1} = \frac{[-16(3)^2+96(3)]-[-16(1)^2+96(1)]}{2} = \frac{144-80}{2} = \frac{64}{2} = 32 \, ft/s}$}} \\
	& \\
	(c) & What was average velocity of the rock between 1 s and 2 s? \\
	\\
	& \ON<1>{\B{$\D{\bar{v}_{1 \to 2} = \frac{s(2)-s(1)}{2-1} = \frac{[-16(2)^2+96(2)]-[-16(1)^2+96(1)]}{1} = \frac{128-80}{1} = 48 \, ft/s}$}} \\
	& \\
	(d) & What was average velocity of the rock between 1 s and $k$ s? (assume $k>1$)\\
	\\
	& \ON<1>{\B{$\D{\bar{v}_{1 \to k} = \frac{s(k)-s(1)}{k-1} = \frac{-16k^2+96k - 80}{k-1} \, ft/s}$}} \\
\end{tabular}}
...
\includegraphics[scale = 0.36]{\PATHTOFIGS/01_01_Fig_03.png}
...
\begin{column}{7.5cm}
	\centering
	\includegraphics[scale = 0.27]{\PATHTOFIGS/01_01_Fig_01.png}

	time interval: [1,3]
\end{column}
\begin{column}{7.0cm}
	\centering
	\includegraphics[scale = 0.27]{\PATHTOFIGS/01_01_Fig_02.png}
...
\begin{tabular}{cp{0.2cm}c}
	\multirow{2}{*}{
	\only<0>{\includegraphics[scale = 0.27]{\PATHTOFIGS/01_01_Fig_04.png}}
	\only<1>{\includegraphics[scale = 0.27]{\PATHTOFIGS/01_01_Fig_05.png}}} & & 
...
\begin{tabular}{p{5.2cm}p{1.3cm}c}
	\includegraphics[scale = 0.27]{\PATHTOFIGS/01_01_Fig_28.png} & & 
	%\includegraphics[scale = 0.27]{\PATHTOFIGS/01_01_Fig_06.png} 
	\\
...
\begin{tabular}{p{0.25cm}p{14.6cm}}
	...
	&\\
	& 
	\ON<1>{\B{$\D m_S = \frac{1-(-2)}{2-6} = -\frac{3}{4}$}}\\
	&\\
	(b) & Under what condition could this slope above be considered an average velocity? \\
	&\\
	& 
	\ON<1>{\B{If $f(x)$ was a position function of $x$ (time)}}\\
\end{tabular}}
...
\begin{tabular}{p{0.25cm}p{14.6cm}}
	...
	\ON<1>{\B{ slope, $m$, and a point, $(x_1,y_1)$, on the line}} which we plug into: 
	\ON<1>{\B{$y-y_1=m(x-x_1)$.  Turns out that we are given both: }} \\
	&\\
	& Since the average velocity = 
	\ON<1>{\B{ slope of the secant line, then $m = 4$.}} \\
	&\\
	& Since the initial position is 5ft, then 
	\ON<1>{\B{$s(0)=5$ or $(x_1,y_1) = (0,5)$. }} \\
	&\\
	& Therefore, the equation of the secant line is: 
	\ON<1>{\B{$y-5=4(x-0)$ or $y=4x+5$}} \\
\end{tabular}}
...
\begin{columns}
\begin{column}{6.5cm}
	\includegraphics[scale = 0.2]{\PATHTOFIGS/01_01_Fig_26.png}
\end{column}
\begin{column}{7.5cm}
	{\setlength{\extrarowheight}{-0.1cm}
...
\begin{columns}
\begin{column}{8cm}
	 \includegraphics[scale = 0.22]{\PATHTOFIGS/01_01_Fig_24.png}
\end{column}
\begin{column}{7.6cm}
...
\begin{column}{7.2cm}
\vspace{0.2cm}
	\includegraphics[scale = 0.19]{\PATHTOFIGS/01_01_Fig_13.png}
\end{column}
\begin{column}{7.5cm}
	\includegraphics[scale = 0.19]{\PATHTOFIGS/01_01_Fig_22.png}
\end{column}
\end{columns}
...
%\begin{center}
%	\only<1>{\includegraphics[scale = 0.22]{\PATHTOFIGS/01_01_Fig_12.png}}
%	\only<1>{\includegraphics[scale = 0.22]{\PATHTOFIGS/01_01_Fig_14.png}}
%	\only<0>{\includegraphics[scale = 0.26]{\PATHTOFIGS/01_01_Fig_13.png}}
%	\only<0>{\includegraphics[scale = 0.26]{\PATHTOFIGS/01_01_Fig_19.png}}
%	\only<0>{\includegraphics[scale = 0.26]{\PATHTOFIGS/01_01_Fig_20.png}}
%	\only<0>{\includegraphics[scale = 0.26]{\PATHTOFIGS/01_01_Fig_22.png}}
%\end{center}
...
%\end{column}
%\begin{column}{10.5cm}
%	\includegraphics[scale = 0.23]{\PATHTOFIGS/01_01_Fig_27.png}
%\end{column}
%\end{columns}
%
%\vspace{0.2cm}
