...
| 11 | `ws-greens-theorem` | Green's Theorem | `02_04_Greens_Theorem` | `sec_greensthm` | in-review |

## Section 3 — Surface Integrals, Stokes', and the Divergence Theorem

Container: `source/notes/sec-surface-integrals.ptx` (created with worksheet 12).

| # | worksheet slug | title | old deck(s) | book section(s) | status |
|---|---|---|---|---|---|
| 12 | `ws-surface-integrals` | Parametrized Surfaces and Surface Integrals | `03_01_SurfaceIntegrals` | `sec_parametric_surfaces`, `sec_surface_integral` | in-review |
